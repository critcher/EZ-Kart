...
(cl:defmethod cl:initialize-instance :after ((m <Command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ez_kart_msgs-msg:<Command> is deprecated: use ez_kart_msgs-msg:Command instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ez_kart_msgs-msg:command-val is deprecated.  Use ez_kart_msgs-msg:command instead.")
  (command m))
