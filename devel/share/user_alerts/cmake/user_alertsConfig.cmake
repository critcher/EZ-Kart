  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'user_alerts' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Clayton <critcher@andrew.cmu.edu>, Mopewa <mogundip@andrew.cmu.edu>, Shastri <shastrir@andrew.cmu.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'user_alerts' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/clayton/robo/EZ-Kart/src/user_alerts/${idir}'.  Ask the maintainer 'Clayton <critcher@andrew.cmu.edu>, Mopewa <mogundip@andrew.cmu.edu>, Shastri <shastrir@andrew.cmu.edu>' to fix it.")
    endif()
