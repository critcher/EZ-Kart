  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'status_monitor' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer ' <blank@blank.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'status_monitor' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/clayton/robo/EZ-Kart/src/status_monitor/${idir}'.  Ask the maintainer ' <blank@blank.com>' to fix it.")
    endif()
...
set(status_monitor_EXPORTED_TARGETS "")
