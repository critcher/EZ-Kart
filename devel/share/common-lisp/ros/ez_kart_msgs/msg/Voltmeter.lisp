...
(cl:defmethod cl:initialize-instance :after ((m <Voltmeter>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Voltmeter)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ez_kart_msgs-msg:<Voltmeter> is deprecated: use ez_kart_msgs-msg:Voltmeter instead.")))

(cl:ensure-generic-function 'voltage-val :lambda-list '(m))
(cl:defmethod voltage-val ((m <Voltmeter>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ez_kart_msgs-msg:voltage-val is deprecated.  Use ez_kart_msgs-msg:voltage instead.")
  (voltage m))
