...
(cl:defmethod cl:initialize-instance :after ((m <Status>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Status)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ez_kart_msgs-msg:<Status> is deprecated: use ez_kart_msgs-msg:Status instead.")))

(cl:ensure-generic-function 'errors-val :lambda-list '(m))
(cl:defmethod errors-val ((m <Status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ez_kart_msgs-msg:errors-val is deprecated.  Use ez_kart_msgs-msg:errors instead.")
  (errors m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <Status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ez_kart_msgs-msg:message-val is deprecated.  Use ez_kart_msgs-msg:message instead.")
  (message m))

(cl:ensure-generic-function 'following-val :lambda-list '(m))
(cl:defmethod following-val ((m <Status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ez_kart_msgs-msg:following-val is deprecated.  Use ez_kart_msgs-msg:following instead.")
  (following m))

(cl:ensure-generic-function 'running-val :lambda-list '(m))
(cl:defmethod running-val ((m <Status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ez_kart_msgs-msg:running-val is deprecated.  Use ez_kart_msgs-msg:running instead.")
  (running m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Status>)))
  ...
  "a34bef720fb1e52aa4039d9fef20f8be")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Status)))
  "Returns md5sum for a message object of type 'Status"
  "a34bef720fb1e52aa4039d9fef20f8be")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Status>)))
  "Returns full string definition for message of type '<Status>"
  (cl:format cl:nil "int32 LOST=0~%int32 OBSTACLE=1~%int32 OVERHEATING=2~%int32 TIPPING=3~%int32 LOW_VOLTAGE=4~%int32[] errors~%string message~%bool following~%bool running~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Status)))
  "Returns full string definition for message of type 'Status"
  (cl:format cl:nil "int32 LOST=0~%int32 OBSTACLE=1~%int32 OVERHEATING=2~%int32 TIPPING=3~%int32 LOW_VOLTAGE=4~%int32[] errors~%string message~%bool following~%bool running~%~%~%"))
