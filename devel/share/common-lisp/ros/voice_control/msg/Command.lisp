...
(cl:defmethod cl:initialize-instance :after ((m <Command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name voice_control-msg:<Command> is deprecated: use voice_control-msg:Command instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader voice_control-msg:command-val is deprecated.  Use voice_control-msg:command instead.")
  (command m))
